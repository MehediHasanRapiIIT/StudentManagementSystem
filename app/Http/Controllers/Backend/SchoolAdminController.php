...
class SchoolAdminController extends Controller
{
    ...
    public function insert_school_admin(Request $request){
        ...
        return redirect('panel/school_admin')->with('success', 'School Admin Created Successfully');
    ...
    public function update_school_admin(Request $request,$id){
        ...
        return redirect('panel/school_admin')->with('success', 'School Admin Updated Successfully');
    }
    ...
    public function delete_school_admin($id){
        ...
        $user->is_delete = 1;
        $user->save();
        return redirect('panel/admin')->with('success', 'Admin Deleted Successfully');
    }
}

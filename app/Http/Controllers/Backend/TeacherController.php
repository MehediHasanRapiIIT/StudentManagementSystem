...
class TeacherController extends Controller
{
    ...
    public function insert_teacher(Request $request){
        ...
        return redirect('panel/teacher')->with('success', 'Teacher Created Successfully');
    ...
    public function edit_teacher($id){
     ...
     public function update_teacher(Request $request,$id){
        ...
        return redirect('panel/teacher')->with('success', 'Teacher Updated Successfully');
     ...
     public function delete_teacher($id){
        ...
        $user->is_delete = 1;
        $user->save();
        return redirect('panel/teacher')->with('success', 'Teacher Deleted Successfully');
     }
}

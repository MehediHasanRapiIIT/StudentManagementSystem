...
class ClassTeacherModel extends Model
{
    ...
    public static function getRecord($user_id,$user_type){
        $return = self::select('class_teacher.*','class.name as class_name','users.name as teacher_name','users.last_name as teacher_lastname');
            ...
            if(!empty(Request::get('status'))){
                ...
                $return= $return->where('class_teacher.status',"=",Request::get('status','=',$status));
            }
    ...
    public static function checkClassTeacher($created_by_id,$class_id,$teacher_id){
    ...
    public static function checkClassTeacherSingle($created_by_id,$class_id,$teacher_id){
        return self::where('created_by_id','=',$created_by_id)
                ->where('class_id','=',$class_id)
                ->where('teacher_id','=',$teacher_id)
                ->where('is_delete','=',0)
    ...
    public static function getSelectedTeacher($class_id, $created_by_id){
        return self::select('class_teacher.*','users.name as teacher_name','users.last_name as teacher_lastname')
    ...
    public static function deleteClassTeacher($class_id,$created_by_id){
    return self::where('created_by_id','=',$created_by_id)
            ->where('class_id','=',$class_id)
            ->delete();
    }

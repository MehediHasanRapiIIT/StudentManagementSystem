<div class="page-sidebar">
    ...
    <ul class="x-navigation">
        <li style="background: #e347">
            <a style="font-size: 20px;text-align: center; font-weight: bold;" href="{{url('panel/dashboard')}}">SMS</a>
        ...
        <li class="{{Request::segment(1) == 'parent' ? 'active' : ''}}"></li>
        ...
        @if (Auth::user()->is_admin == 1 || Auth::user()->is_admin == 2 || Auth::user()->is_admin == 3)
            ...
            <li class="{{Request::segment(2) == 'parent' ? 'active' : ''}}">
                <a href="{{url('panel/parent')}}"><span class="fa fa-male"></span> <span class="xn-text">Parent</span></a>
            </li>
            ...
            <li class="xn-openable {{Request::segment(2) == 'class' || Request::segment(2) == 'subject' || Request::segment(2) == 'class-timetable' || Request::segment(2) == 'assign-subject' || Request::segment(2) == 'assign-class-teacher' ? 'active' : ''}}">
                ...
                <ul>
                    <li class="{{Request::segment(2) == 'class' ? 'active' : ''}}"><a href="{{url('panel/class')}}"><span
                                class="fa fa-users"></span> <span class="xn-text">Class</span></a></li>

...
@section('content')
    ...
    <div class="page-title">
        <h2><span class="fa fa-arrow-circle-o-left"></span>Assign Subject</h2>
    </div>
    <!-- END PAGE TITLE -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <a class="btn btn-primary pull-right" href="{{url("panel/assign-subject/create")}}">Create Assign Subject</a>
                    </div>
